                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="/crm/project" class="dropdown-item">Danh sách dự án</a>
                            <a href="/crm/request" class="dropdown-item">Danh sách yêu cầu</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Danh mục</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="/crm/categories" class="dropdown-item">Danh sách thể loại</a>
                            <a href="/crm/level" class="dropdown-item">Danh sách cấp độ</a>
                            <a href="/crm/status" class="dropdown-item">Danh sách trạng thái</a>
                        </div>
                    </div>
